"""
Iker Blazquez Valverde, Ruben Blas Lario
UF1 M03 Asixc 1A
...
# Definicion de datos
fila_2022 = dades[0][1:-1]
mitj2022 = dades[0][-1]
maxtemp2022 = fila_2022[0]
mintemp2022 = fila_2022[0]
minimo = dades[0][0]
maximo = dades[0][1]

# Programa
mitjaslinea = [sum(linea[1:-1]) / len(linea[1:-1]) for linea in dades]
mediaTotal = sum(mitjaslinea) / len(mitjaslinea)

for temp in fila_2022:
    if temp < mintemp2022:
        mintemp2022 = temp
    elif temp > maxtemp2022:
        maxtemp2022 = temp

for lista in dades:
    for temp in lista[1:-1]:
        if temp < minimo:
            minimo = temp
        elif temp > maximo:
            maximo = temp
...
print("·Any 2022:\n   ·Màxima:", maxtemp2022, "\n   ·Mínima:", mintemp2022, "\n   ·Mitjana:", mitj2022)
print()
print("·Anys 2000 a 2022:\n   ·Màxima:", maximo, "\n   ·Mínima:", minimo, "\n   ·Mitjana:", round(mediaTotal, 2))
